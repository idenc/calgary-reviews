...
INSERT INTO `business_hours` (`r_id`, `day_of_week`, `open_time`, `close_time`)
VALUES
...
INSERT INTO `photo` (`photo_id`, `title`, `date_posted`, `category`, `num_likes`, `file_path`)
VALUES
...
INSERT INTO `restaurant` (`r_id`, `name`, `location`, `wifi`, `delivery`, `alcohol`, `phone_num`, `website`, `pending`)
VALUES
(1, 'Minhas Micro Brewery', '1314 44 Avenue NE', NULL, 0, 1, '(403) 695-3701',
 'http://minhasbrewery.com/minhas-micro-brewery-calgary', 0x00),
(2, 'Kinjo Sushi', '5005 Dalhousie Drive NW Unit 415', 0, 1, 1, '(403) 452-8389', 'https://www.kinjosushiandgrill.com/',
 0x30);
...
INSERT INTO `review` (`content`, `rating`, `date_posted`, `r_id`, `user_id`, `cost`)
VALUES
('Amazing!!! We did the tour for 4 and had such a great time. Tanner was very informative and very generous with beer samples :p It was an awesome experience seeing behind the scenes.\r\nWhat an awesome time. It was a better than we expected Would 10/10 recommend!!!',
 '5', '2018-11-23 08:31:14', 1, 'idenc', '2'),
('Fun tour! You see the entire production process from grain to can! Absolutely loved the samples we were given and was blown away by how delicious the beers were. I\'m not too much of a beer person, but I think Minhas is going to change that real soon.',
 '2', '2018-11-25 02:23:08', 1, 'abcd', '3');
...
INSERT INTO `uploads` (`user_id`, `photoid`, `r_id`)
VALUES
  ('idenc', 1, 1),
  ('admin', 2, 2),
  ('admin', 3, 2),
...
INSERT INTO `user` (`username`, `password`, `date_joined`, `user_type`, `fname`, `lname`)
VALUES
